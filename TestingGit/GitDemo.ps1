...
git commit -m "GitDemo stored in seperate folder"
...
git remote add origin https://github.com/DanielAyo/PowerShell/
...
#used in a rare event that merges histories of two projects that started their lives independently.
...
#instead of having to upload your site with an ftp client.
#
